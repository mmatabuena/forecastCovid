...
#setwd("~/Modelo_Covid_descargado/Results/Mexico/")

##############################
##### CAMBIAR DENDE AQUÍ #####
##############################

i=151 #indice da autonomia
i1_raw= read.table("../../src/Results/World/Mexico/SimulaMexico_I1.txt")
i2_raw= read.table("../../src/Results/World/Mexico/SimulaMexico_I2.txt")
i3_raw= read.table("../../src/Results/World/Mexico/SimulaMexico_I3.txt")
r1_raw= read.table("../../src/Results/World/Mexico/SimulaMexico_R1.txt")
r2_raw= read.table("../../src/Results/World/Mexico/SimulaMexico_R2.txt")
mortos_raw=read.table("../../src/Results/World/Mexico/SimulaMexico_XM.txt")
erro=read.table("../../src/Results/World/Mexico/SimulaMexico_Error.txt")
reais_raw=read.table("../../src/Results/World/Mexico/SimulaMexico_XM_Real.txt")
...
```{r message=FALSE, warning=FALSE, include=FALSE}
png("Mexico/Image_M.png",width=1600,height=800)
p1
dev.off()

jpeg("Mexico/Image_M.jpg",width=960,height=540,quality = 50)
p1
dev.off()


png("Mexico/Image_I1.png",width=1600,height=800)
p2
dev.off()

jpeg("Mexico/Image_I1.jpg",width=960,height=540,quality = 50)
p2
dev.off()

png("Mexico/Image_I2.png",width=1600,height=800)
p3
dev.off()

jpeg("Mexico/Image_I2.jpg",width=960,height=540,quality = 50)
p3
dev.off()


png("Mexico/Image_I3.png",width=1600,height=800)
p4
dev.off()

jpeg("Mexico/Image_I3.jpg",width=960,height=540,quality = 50)
p4
dev.off()


png("Mexico/Image_R1.png",width=1600,height=800)
p5
dev.off()

jpeg("Mexico/Image_R1.jpg",width=960,height=540,quality = 50)
p5
dev.off()


png("Mexico/Image_R2.png",width=1600,height=800)
p6
dev.off()

jpeg("Mexico/Image_R2.jpg",width=960,height=540,quality = 50)
p6
dev.off()


png("Mexico/Image_T.png",width=1600,height=800)
p7
dev.off()

jpeg("Mexico/Image_T.jpg",width=960,height=540,quality = 50)
p7
dev.off()


png("Mexico/Image_TR.png",width=1600,height=800)
p8
dev.off()

jpeg("Mexico/Image_TR.jpg",width=960,height=540,quality = 50)
p8
dev.off()
