...
i1_raw= read.table("../../src/Results/World/Zona_Test/SimulaZona_Test_I1.txt")
i2_raw= read.table("../../src/Results/World/Zona_Test/SimulaZona_Test_I2.txt")
i3_raw= read.table("../../src/Results/World/Zona_Test/SimulaZona_Test_I3.txt")
r1_raw= read.table("../../src/Results/World/Zona_Test/SimulaZona_Test_R1.txt")
r2_raw= read.table("../../src/Results/World/Zona_Test/SimulaZona_Test_R2.txt")
mortos_raw=read.table("../../src/Results/World/Zona_Test/SimulaZona_Test_XM.txt")
erro=read.table("../../src/Results/World/Zona_Test/SimulaZona_Test_Error.txt")
reais_raw=read.table("../../src/Results/World/Zona_Test/SimulaZona_Test_XM_Real.txt")
