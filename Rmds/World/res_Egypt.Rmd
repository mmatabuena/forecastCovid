...
#setwd("~/Modelo_Covid_descargado/Results/Egypt/")

##############################
##### CAMBIAR DENDE AQUÍ #####
##############################

i=65 #indice da autonomia
i1_raw= read.table("../../src/Results/World/Egypt/SimulaEgypt_I1.txt")
i2_raw= read.table("../../src/Results/World/Egypt/SimulaEgypt_I2.txt")
i3_raw= read.table("../../src/Results/World/Egypt/SimulaEgypt_I3.txt")
r1_raw= read.table("../../src/Results/World/Egypt/SimulaEgypt_R1.txt")
r2_raw= read.table("../../src/Results/World/Egypt/SimulaEgypt_R2.txt")
mortos_raw=read.table("../../src/Results/World/Egypt/SimulaEgypt_XM.txt")
erro=read.table("../../src/Results/World/Egypt/SimulaEgypt_Error.txt")
reais_raw=read.table("../../src/Results/World/Egypt/SimulaEgypt_XM_Real.txt")
...
reaisi=as.numeric(reais[(reais$name)=="Egypt",])
...
```{r message=FALSE, warning=FALSE, include=FALSE}
png("Egypt/Image_M.png",width=1600,height=800)
p1
dev.off()

jpeg("Egypt/Image_M.jpg",width=960,height=540,quality = 50)
p1
dev.off()


png("Egypt/Image_I1.png",width=1600,height=800)
p2
dev.off()

jpeg("Egypt/Image_I1.jpg",width=960,height=540,quality = 50)
p2
dev.off()

png("Egypt/Image_I2.png",width=1600,height=800)
p3
dev.off()

jpeg("Egypt/Image_I2.jpg",width=960,height=540,quality = 50)
p3
dev.off()


png("Egypt/Image_I3.png",width=1600,height=800)
p4
dev.off()

jpeg("Egypt/Image_I3.jpg",width=960,height=540,quality = 50)
p4
dev.off()


png("Egypt/Image_R1.png",width=1600,height=800)
p5
dev.off()

jpeg("Egypt/Image_R1.jpg",width=960,height=540,quality = 50)
p5
dev.off()


png("Egypt/Image_R2.png",width=1600,height=800)
p6
dev.off()

jpeg("Egypt/Image_R2.jpg",width=960,height=540,quality = 50)
p6
dev.off()


png("Egypt/Image_T.png",width=1600,height=800)
p7
dev.off()

jpeg("Egypt/Image_T.jpg",width=960,height=540,quality = 50)
p7
dev.off()


png("Egypt/Image_TR.png",width=1600,height=800)
p8
dev.off()

jpeg("Egypt/Image_TR.jpg",width=960,height=540,quality = 50)
p8
dev.off()
