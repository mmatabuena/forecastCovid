...
ggplot(mord) +
  geom_line(aes(dia, 10*cantos/autonomias$Población[i],group= V1,alpha=exp(-dis^2)),colour='#00C08D',show.legend=FALSE) +
  scale_x_date() +
  theme_bw() +
  labs(x = "Date", y = "", 
