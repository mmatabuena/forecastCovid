...
i1_raw= read.table("../src/Results/Vasco/SimulaVasco_I1.txt")
i2_raw= read.table("../src/Results/Vasco/SimulaVasco_I2.txt")
i3_raw= read.table("../src/Results/Vasco/SimulaVasco_I3.txt")
r1_raw= read.table("../src/Results/Vasco/SimulaVasco_R1.txt")
r2_raw= read.table("../src/Results/Vasco/SimulaVasco_R2.txt")
mortos_raw=read.table("../src/Results/Vasco/SimulaVasco_XM.txt")
erro=read.table("../src/Results/Vasco/SimulaVasco_Error.txt")
...
ggplot(r1ord) +
  geom_line(aes(dia, 100*cantos/autonomias$Población[i],group= V1,alpha=exp(-1000*dis)),colour='#00C08D',show.legend=FALSE) +
  scale_x_date() +
  theme_bw() +
  labs(x = "Date", y = "", 
