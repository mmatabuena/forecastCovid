...
i1_raw= read.table("~/Modelo_Covid_descargado/Results/Andalucia/SimulaAndalucia_I1.txt")
i2_raw= read.table("~/Modelo_Covid_descargado/Results/Andalucia/SimulaAndalucia_I2.txt")
i3_raw= read.table("~/Modelo_Covid_descargado/Results/Andalucia/SimulaAndalucia_I3.txt")
r1_raw= read.table("~/Modelo_Covid_descargado/Results/Andalucia/SimulaAndalucia_R1.txt")
r2_raw= read.table("~/Modelo_Covid_descargado/Results/Andalucia/SimulaAndalucia_R2.txt")
mortos_raw=read.table("~/Modelo_Covid_descargado/Results/Andalucia/SimulaAndalucia_XM.txt")
erro=read.table("~/Modelo_Covid_descargado/Results/Andalucia/SimulaAndalucia_Error.txt")
