...
i1_raw= read.table("../../src/Results/Italia/Total/SimulaTotal_I1.txt")
i2_raw= read.table("../../src/Results/Italia/Total/SimulaTotal_I2.txt")
i3_raw= read.table("../../src/Results/Italia/Total/SimulaTotal_I3.txt")
r1_raw= read.table("../../src/Results/Italia/Total/SimulaTotal_R1.txt")
r2_raw= read.table("../../src/Results/Italia/Total/SimulaTotal_R2.txt")
mortos_raw=read.table("../../src/Results/Italia/Total/SimulaTotal_XM.txt")
erro=read.table("../../src/Results/Italia/Total/SimulaTotal_Error.txt")
reais_raw=read.table("../../src/Results/Italia/Total/SimulaTotal_XM_Real.txt")
