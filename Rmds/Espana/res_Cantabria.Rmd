...
reais_raw=read.table("../../src/Results/Espana/Cantabria/SimulaCantabria_XM_Real.txt")
...
parametros= read.table("../../src/Results/Espana/Cantabria/SimulaCantabria_Param.txt")
