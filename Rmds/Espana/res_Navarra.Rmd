...
png("Navarra/Image_M.png",width=960,height=540)
p1
dev.off()

png("Navarra/Image_I1.png",width=960,height=540)
p2
dev.off()

png("Navarra/Image_I2.png",width=960,height=540)
p3
dev.off()

png("Navarra/Image_I3.png",width=960,height=540)
p4
dev.off()

png("Navarra/Image_R1.png",width=960,height=540)
p5
dev.off()

png("Navarra/Image_R2.png",width=960,height=540)
p6
dev.off()

png("Navarra/Image_T.png",width=960,height=540)
p7
dev.off()

png("Navarra/Image_TR.png",width=960,height=540)
p8
dev.off()
```
