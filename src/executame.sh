...
./runsimular_paral 20 500000 1000 "../cluster_data/Leon/ParInit_Optimos_Exp6.txt" "Leon" | tee Ejemplo_Leon.txt
./runsimular_paral 20 500000 1000 "../cluster_data/Vasco/ParInit_Optimos_Exp6.txt" "Vasco" | tee Ejemplo_Vasco.txt
./runsimular_paral 20 500000 1000 "../cluster_data/Madrid/ParInit_Optimos_Exp6.txt" "Madrid" | tee Ejemplo_Madrid.txt
