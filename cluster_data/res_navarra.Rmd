...
i1_raw= read.table("~/Modelo_Covid_descargado/Results/Navarra/SimulaNavarra_I1.txt")
i2_raw= read.table("~/Modelo_Covid_descargado/Results/Navarra/SimulaNavarra_I2.txt")
i3_raw= read.table("~/Modelo_Covid_descargado/Results/Navarra/SimulaNavarra_I3.txt")
r1_raw= read.table("~/Modelo_Covid_descargado/Results/Navarra/SimulaNavarra_R1.txt")
r2_raw= read.table("~/Modelo_Covid_descargado/Results/Navarra/SimulaNavarra_R2.txt")
mortos_raw=read.table("~/Modelo_Covid_descargado/Results/Navarra/SimulaNavarra_XM.txt")
erro=read.table("~/Modelo_Covid_descargado/Results/Navarra/SimulaNavarra_Error.txt")
