...
i1_raw= read.table("~/Modelo_Covid_descargado/Results/Galicia/SimulaGalicia_I1.txt")
i2_raw= read.table("~/Modelo_Covid_descargado/Results/Galicia/SimulaGalicia_I2.txt")
i3_raw= read.table("~/Modelo_Covid_descargado/Results/Galicia/SimulaGalicia_I3.txt")
r1_raw= read.table("~/Modelo_Covid_descargado/Results/Galicia/SimulaGalicia_R1.txt")
r2_raw= read.table("~/Modelo_Covid_descargado/Results/Galicia/SimulaGalicia_R2.txt")
mortos_raw=read.table("~/Modelo_Covid_descargado/Results/Galicia/SimulaGalicia_XM.txt")
erro=read.table("~/Modelo_Covid_descargado/Results/Galicia/SimulaGalicia_Error.txt")
